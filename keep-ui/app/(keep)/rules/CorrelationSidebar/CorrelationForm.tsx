        ...
        <div className="flex items-center justify-between">
          <label className="text-tremor-default font-medium text-tremor-content-strong flex items-center">
            ...
            <Button
              className="cursor-default ml-2"
              type="button"
            tooltip="Add metadata to incidents created by this correlation rule. With KEEP_STORE_RAW_ALERTS enabled, scalar fields from the provider raw payload are added automatically; user-defined values override them. Templates support normalized alert paths ({{ alert.labels.owner }}) and raw webhook paths ({{ alerts[0].condition }} or {{ raw.title }})."
              icon={QuestionMarkCircleIcon}
              size="xs"
              variant="light"
              color="slate"
